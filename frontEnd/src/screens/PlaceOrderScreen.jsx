        ...
        <Row>
          <Col md={8}>
            <Card className="mb-3">
              <Card.Body>
                <Card.Title>
                  <p style={{ color: "green" }}>Shipping</p>
                </Card.Title>
                <Card.Text>
            ...
            <Card>
              <Card.Body>
                ...
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <Row>
                      <Col style={{ color: "green" }}>Items</Col>
                      <Col> ₦{cart.itemsPrice.toFixed(2)}</Col>
                    </Row>
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <Row>
                      <Col style={{ color: "green" }}>Shipping</Col>
                      <Col> ₦{cart.shippingPrice.toFixed(2)}</Col>
                    </Row>
                  </ListGroup.Item>
                  <ListGroup.Item>
                    <Row>
                      <Col style={{ color: "green" }}>Tax</Col>
