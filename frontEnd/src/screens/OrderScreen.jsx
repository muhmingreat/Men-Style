  ...
  return loading ? (
    ...
    <div>
      ...
      <Container className="mt-3">
        <h1 className="my-3" style={{ color: "green" }}>
          Order {orderId}
        </h1>
        <Row>
          <Col md={8}>
            ...
            <Card className="mb-3">
              <Card.Body>
                ...
                <Card.Text>
                  <strong style={{ color: "blue" }}>Method:</strong>{" "}
                  {order.paymentMethod}
                </Card.Text>
                {order.isPaid ? (
                  <MessageBox variant="success">
            ...
            <Card className="mb-3">
              <Card.Body>
                ...
                <ListGroup variant="flush">
                  <ListGroup.Item>
                    <Row>
                      <Col style={{ color: "blue" }}>Items</Col>
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col style={{ color: "blue" }}>Shipping</Col>
                      <Col style={{ color: "blue" }}>
                        {" "}
                  ...
                  <ListGroup.Item>
                    <Row>
                      <Col>
                        <strong style={{ color: "blue" }}> Order Total</strong>
                      </Col>
                      <Col>
